...
public class InvalidAssets extends JFrame implements ActionListener,
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (jTextField1.getText() == null
			...
			JOptionPane.showMessageDialog(null, "没有这个设备", "错误",
			...
			if (obj == modifyInfo) {// 修改
				...
				atbean.add(JourNo, "设备报废", AssetsID, f4, PersonID,
